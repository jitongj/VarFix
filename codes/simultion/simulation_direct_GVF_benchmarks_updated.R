...
output_dir <- here::here("figures", "simulation", "direct_GVF_benchmarks")
dir.create(output_dir, recursive = TRUE, showWarnings = FALSE)

saveRDS(
  all_detailed_results,
  file.path(output_dir, "simulation_direct_GVF_detailed_results.rds")
)
saveRDS(
  all_summary_metrics,
  file.path(output_dir, "simulation_direct_GVF_performance_summary.rds")
)
...
save(
  all_detailed_results,
  all_summary_metrics,
  file = here::here("data", "sim_f1_s1_p1_r0.042_nationalWeight_GVF.RData")
)

ggsave(
  filename = file.path(output_dir, "simulation_direct_GVF_coverage.png"),
  plot = p_cov_z,
  width = 14, height = 6, dpi = 300
)
ggsave(
  filename = file.path(output_dir, "simulation_direct_GVF_ci_width.png"),
  plot = p_wz,
  width = 14, height = 6, dpi = 300
)
ggsave(
  filename = file.path(output_dir, "simulation_direct_GVF_interval_score.png"),
  plot = p_sz,
  width = 14, height = 6, dpi = 300
)
ggsave(
  filename = file.path(
    output_dir,
    "simulation_direct_GVF_bias_variance_estimators.png"
  ),
  plot = p_bias_var_est,
  width = 14,
  height = 6,
...
ggsave(
  filename = file.path(
    output_dir,
    "simulation_direct_GVF_coverage_95.png"
  ),
  plot = p_cov_z_095,
  width = 14,
  height = 6,
...
ggsave(
  filename = file.path(
    output_dir,
    "simulation_direct_GVF_ci_width_95.png"
  ),
  plot = p_wz_095,
  width = 14,
  height = 6,
...
ggsave(
  filename = file.path(
    output_dir,
    "simulation_direct_GVF_interval_score_95.png"
  ),
  plot = p_sz_095,
  width = 14,
  height = 6,
